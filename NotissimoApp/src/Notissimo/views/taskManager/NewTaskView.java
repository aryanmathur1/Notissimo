    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == createButton) {
            ...
            if (!noteField.getText().isEmpty() && !monthField.getText().isEmpty() && !dayField.getText().isEmpty() && !yearField.getText().isEmpty()) {
                ...
                notesBuilder.addNote("title", noteField.getText(), Integer.parseInt(monthField.getText()), Integer.parseInt(dayField.getText()), Integer.parseInt(yearField.getText()), false);
                notesBuilder.write();
